        ...
        >
          ...
          {!emailSent ? (
            ...
            <div className="text-center py-4">
              ...
              <p className="text-neutral-500 font-lato text-sm mb-1">
                We've sent a password reset link to
              </p>
              <p className="text-neutral-800 font-semibold font-lato mb-6">
                {email}
              </p>
              <p className="text-neutral-400 font-lato text-xs mb-6">
              ...
              <button
                onClick={onBackToLogin}
                className="text-teal-700 font-semibold hover:underline font-lato"
              >
                Back to login
              </button>
            </div>
