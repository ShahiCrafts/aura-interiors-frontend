 ...
 * Displays notification list with pagination
 * Supports marking as read and archiving
 */
  ...
  return (
    <div className="absolute top-full right-0 w-96 bg-white rounded-xl shadow-lg z-1000 mt-2 overflow-hidden flex flex-col max-h-96 animate-slideDown md:w-full md:max-w-sm">
      ...
      <div className="flex justify-between items-center p-4 border-b border-gray-100">
        <h3 className="m-0 text-lg font-semibold text-gray-900">Notifications</h3>
        {unreadCount > 0 && (
          <button
              ...
              return (
                <div
                  ...
                  className={`flex items-start px-4 py-3 border-b border-gray-100 cursor-pointer transition-colors duration-200 bg-white hover:bg-gray-50 ${
                    !notification.isRead ? `${categoryBgColors[category]} hover:opacity-90` : ''
                ...
                >
                  ...
                  >
                    ...
                    {/* CATEGORY BADGE */}
                    <span className={`inline-block px-2 py-1 rounded-full text-xs font-semibold uppercase flex-shrink-0 ml-2 ${categoryBadgeColors[category]}`}>
                      {category}
                    </span>
                  </div>
      ...
      {notifications.length > 0 && (
        <div className="flex justify-center gap-4 p-3 border-t border-gray-100 bg-gray-50">
          ...
          <a href="/notifications" className="text-blue-600 no-underline text-xs px-2 py-1 rounded font-medium transition-all duration-200 hover:bg-blue-50 hover:text-blue-800">
