  ...
  return (
    <div className="relative inline-block" ref={bellRef}>
      ...
      >
        ...
        {/* BADGE */}
        {unreadCount > 0 && (
          <span className="absolute top-0 right-0 flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-gradient-to-br from-red-500 to-red-600 rounded-full shadow-lg animate-pulse">
            {unreadCount > 99 ? "99+" : unreadCount}
          </span>
        )}

        {/* CONNECTION INDICATOR */}
        <span className={`absolute bottom-0 right-0 w-2.5 h-2.5 border-2 border-white rounded-full transition-all duration-300 ${
