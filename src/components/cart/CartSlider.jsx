...
const EmptyCartIllustration = () => (
  <svg width="120" height="120" viewBox="0 0 132 132" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="111.467" y="14.6665" width="5.86667" height="5.86667" rx="2.93333" fill="#0D9488"/>
    <rect x="11" y="29.3333" width="4.4" height="4.4" rx="2.2" fill="#0D9488"/>
    <rect x="121" y="91.6663" width="3.66667" height="3.66667" rx="1.83333" fill="#0D9488"/>
    ...
    <rect x="29.3333" y="114.4" width="17.6" height="17.6" rx="8.8" fill="#E5E7EB"/>
    <rect x="34.4666" y="119.533" width="7.33333" height="7.33333" rx="3.66667" fill="white"/>
    <rect x="85.0667" y="114.4" width="17.6" height="17.6" rx="8.8" fill="#E5E7EB"/>
...
export default function CartSlider({ isOpen, onClose }) {
  ...
  const totalItems = isAuthenticated ? (cart?.totalItems || 0) : guestTotals.itemCount;
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-neutral-100">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="text-sm text-neutral-400">({totalItems}) items</span>
            </div>
          </div>
          <button
            onClick={onClose}
                ...
                return (
                  ...
                  >
                    ...
                    <Link
                      ...
                      onClick={onClose}
                      className="w-[72px] h-[72px] flex-shrink-0 rounded-lg overflow-hidden bg-white"
                    >
                      <img
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          ...
                          disabled={isRemoving}
                          className="w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-md text-red-500 hover:bg-red-50 transition-colors disabled:opacity-50"
                        >
                          <Trash2 size={14} />
                        </button>
                      </div>
