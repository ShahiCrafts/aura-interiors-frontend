...
export default function Footer() {
  ...
  const links = {
    company: ["About Us", "Careers", "Blog", "Contact", "FAQ"],
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-20 py-12 sm:py-16">
        {/* Newsletter Section */}
        <div
          className={`flex flex-col items-center text-center mb-12 sm:mb-16 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
        ...
        {/* Links Grid */}
        <div
          className={`grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-16 mb-10 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600 text-sm sm:text-base">
              {links.company.map((link, i) => (
                <li key={i}>
                  <a
                    href={link === "FAQ" ? "/faq" : link === "Contact" ? "/contact" : link === "Blog" ? "/blog" : "#"}
                    className="hover:text-teal-700 transition-colors"
                  >
                    {link}
                  </a>
        ...
        {/* Bottom Bar */}
        <div
          className={`border-t border-gray-300 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6 text-gray-500 text-sm transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
